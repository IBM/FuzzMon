...
public final class DotFormatter {
    ...
    private DotFormatter(Node n, ControlFlowGraph<Node> cfg,
        ...
        formatPreamble((null == cfg) ? "CFG" : "AST");
        traverseNodes(n);
        formatConclusion();
    }
    ...
    int key(Node n) throws IOException {
        ...
        if (key == null) {
            ...
            builder.append("\\n");
            builder.append("{" + n.getLineno() + "," + n.getCharno() + "}");
            if ((Token.STRING == n.getToken()) || (Token.NAME == n.getToken())) {
                builder.append("\\n");
                builder.append(n.getString());
            };
            builder.append("\\n");
            builder.append(n.getSourceFileName());
    ...
    private void formatPreamble(String graphType) throws IOException {
        builder.append("digraph "+ graphType +" {\n");
        builder.append(INDENT);
        builder.append("node [color=lightblue2, style=filled];\n");
    }
